...
compare_pair() {
  ...
  local pop_file="$SCRIPT_DIR/${stem}.pop"
  local js_file="$SCRIPT_DIR/${stem}.js"
...
compare_pair "Arithmetic Loop" "arithmetic_loop"
compare_pair "Function Call Heavy" "call_heavy"
compare_pair "Variable Lookup Heavy" "lookup_heavy"
